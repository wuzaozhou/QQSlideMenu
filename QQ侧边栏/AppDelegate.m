...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    KKLeftVC *left = [[KKLeftVC alloc] init];
    ...
    KKMenuViewController *vc = [[KKMenuViewController alloc] initWithRootViewController:tabbarVC leftViewController:left rightViewController:right];
